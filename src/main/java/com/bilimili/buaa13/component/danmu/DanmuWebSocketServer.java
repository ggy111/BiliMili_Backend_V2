...
public class DanmuWebSocketServer {
    ...
    private static JsonWebTokenTool jwtUtil;
    private static RedisTool redisUtil;
    private static DanmuMapper danmuMapper;
    private static VideoStatusService videoStatsService;
    private  static RedisTemplate<String, Object> redisTemplate;

    @Autowired
    public void setDependencies(JsonWebTokenTool jwtUtil, RedisTool redisUtil, DanmuMapper danmuMapper, VideoStatusService videoStatsService, RedisTemplate<String, Object> redisTemplate) {
        ...
        DanmuWebSocketServer.redisTemplate = redisTemplate;
    }
...
//            System.out.println(data);
            ...
            videoStatsService.updateVideoStatus(Integer.parseInt(vid), "danmu", true, 1);
            redisTemplate.opsForSet().add("danmu_idset:" + vid, danmu.getId());   // 加入对应视频的ID集合，以便查询
